...
function addInput(divName, counter) {
    for (i = 1; i <= counter; i++) {
        ...
        <div class='col-50'> <label class="label success" style="min-width:100%;background-color: #84cfff;color: black;text-align: center;font-weight: bolder;padding: 0.5rem; font-family: 'IBM Plex Serif', serif;text-transform: uppercase;"><i class="fa fa-check-circle"
            style="width:max-content;  color: black;font-size: larger;text-transform:uppercase;"> </i>  COURSE NO. - ${i}</label>
        </div>
    </div>
<div class='row'><div class='col-75'>     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"> Course Code Subject - ${i} </label>
  ...
  <div class='row'><div class='col-75'>     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"> Marks Obtained Subject - ${i} </label>
  ...
  <div class='row'><div class='col-75'>     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"> Total Marks Subject - ${i} </label>
...
function addInput_cgpa(divName_cgpa, counter_cgpa) {
    for (i = 0; i <= counter_cgpa - 2; i++) {
        ...
        var newdiv_cgpa = document.createElement("div");
        newdiv_cgpa.innerHTML = `<div class="row">
        <div class='col-50'> <label class="label success" style="min-width:100%;background-color: #84cfff;color: black;text-align: center;font-weight: bolder;padding: 0.5rem; font-family: 'IBM Plex Serif', serif;text-transform: uppercase;"><i class="fa fa-check-circle"
            style="width:max-content;  color: black;font-size: larger;text-transform: uppercase;"> </i> SEMESTER - ${
                i + 1}</label>
        </div>
    </div><div class='row'><div class='col-75'>     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"> Credits Of Semester - ${
        i + 1
      } : </label>
      ...
      <div class='row'><div class='col-75'> <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"> SGPA Of Semester - ${
        i + 1
...
for (let i = 0; i < document.getElementsByClassName("branch").length; i++) {
    document.getElementsByClassName("branch")[i].innerHTML = branch;
}
for (let i = 0; i < document.getElementsByClassName("semester").length; i++) {
    document.getElementsByClassName("semester")[i].innerHTML = semester;
}
