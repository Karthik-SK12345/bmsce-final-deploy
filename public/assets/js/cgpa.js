...
function addInput(divName, counter) {
    ...
    </div><div class='row'><div class='col-75'>     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"> Credits Of Semester - ${i} : </label>
    ...
    <div class='row'><div class='col-75'> <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"> SGPA Of Semester - ${i} : </label></div><div class='col-25'>  <input type="number" max="10" onkeyup="if (this.value[this.value.length - 1] == '.') this.value = this.value.substr(0, this.value.length - 1); if (parseFloat(this.value) > 10) this.value = '10';" placeholder="SGPA" id='${sid}' ></div> </div>
    <hr style="
    border: 0;
